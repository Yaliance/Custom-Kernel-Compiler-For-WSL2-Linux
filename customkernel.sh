...
#sudo mkdir /mnt/c/Users/$winusr/CustomKernel
#sudo cp arch/x86/boot/bzImage /mnt/c/Users/$winusr/CustomKernel
if [ -f "$wslfile" ]; then
...
#sudo touch /mnt/c/Users/$winusr/CustomKernel/.wslconfig
#sudo echo -e "[wsl2]\nkernel=C:\\Users\\" >> /mnt/c/Users/$winusr/CustomKernel/.wslconfig
#sudo echo -e "$winusr\\bzImage\nswap=0\nlocalhostForwarding=true" >> /mnt/c/Users/$winusr/CustomKernel/.wslconfig

#if [ -d "/lib/modules/$(uname -r)/kernel" ]
#then
#        echo -e "\n\n\n ${green}El proceso ha sido completado con exito\n\n\nEl kernel (bzImage) se ha guardado en tu carpeta de usuario en Windows${reset}"
#else
#        echo -e "\n\n\n ${red}Algo fallo durante el proceso. Por favor intentelo de nuevo.${reset}"
#        exit
#fi
...
#echo -e "$Kernelcomp $Filecreation"
